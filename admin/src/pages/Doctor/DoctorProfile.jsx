            ...
            <p className='text-sm text-gray-600 max-w-[700px] mt-1'>
              ...
              <div className='flex gap-2 py-2'>
                  ...
                  <p className='text-sm'>
                    ...
                    <br />
                    {isEdit ? <input type="text" onChange={(e)=>setProfileData(prev =>({...prev,address:{...prev.address,lin2:e.target.value}}))} value={profileData.address.lin2} />:profileData.address.lin2}
